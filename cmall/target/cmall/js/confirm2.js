...
webpackJsonp([2], {
    0: function (t, e, r) {
        ...
        "use strict";
        var i = r(4);
        const n = {serverHost: "", imageHost: "http://img.happymmall.com/"};
        var s = {
            request: function (t) {
                ...
                $.ajax({
                    ...
                    data: t.data || "",
                    success: function (i) {
                        0 === i.status ? "function" == typeof t.success && t.success(i.data, i.msg) : 10 === i.status && r ? e.doLogin() : 10 !== i.status || t.forceLogin ? "function" == typeof t.error && t.error(i.msg || i.data) : "function" == typeof t.error && t.error(i.msg || i.msg)
                    },
                    error: function (e) {
                ...
                var r = i.compile(t), n = r.render(e);
                return n
        ...
        var i = r(1), n = {
            checkUsername: function (t, e, r) {
                ...
                i.request({url: i.getServerUrl("/user/register.do"), method: "POST", data: t, success: e, error: r})
            }, login: function (t, e, r) {
                i.request({url: i.getServerUrl("/user/login.do"), method: "POST", data: t, success: e, error: r})
            }, logout: function (t, e) {
                i.request({url: i.getServerUrl("/user/logout.do"), method: "POST", success: t, error: e})
            }, checkLogin: function (t, e) {
                i.request({url: i.getServerUrl("/user/get_user_info.do"), method: "POST", success: t, error: e})
                ...
                i.request({url: i.getServerUrl("/user/get_information.do"), method: "POST", success: t, error: e})
        ...
        !function (t) {
            ...
            function n(e, r, i, o) {
                var c = [], u = null, d = null, l = null;
                for (d = i[i.length - 1]; e.length > 0;) {
                    if (l = e.shift(), d && "<" == d.tag && !(l.tag in k))throw new Error("Illegal content in < super tag.");
                    if (t.tags[l.tag] <= t.tags.$ || s(l, o))i.push(l), l.nodes = n(e, l.tag, i, o); else {
                        if ("/" == l.tag) {
                            if (0 === i.length)throw new Error("Closing tag without opener: /" + l.n);
                            if (u = i.pop(), l.n != u.n && !a(l.n, u.n, o))throw new Error("Nesting error: " + u.n + " vs. " + l.n);
                            return u.end = l.i, c
                        }
            ...
            t.tags = {
                ...
                function o() {
                    for (var e = !0, r = $; r < w.length; r++)if (e = t.tags[w[r].tag] < t.tags._v || "_t" == w[r].tag && null === w[r].text.match(h), !e)return !1;
                    return e
                }

                function c(t, e) {
                    if (a(), t && o())for (var r, i = $; i < w.length; i++)w[i].text && ((r = w[i + 1]) && ">" == r.tag && (r.indent = w[i].text.toString()), w.splice(i, 1)); else e || w.push({tag: "\n"});
                    S = !1, $ = w.length
                }

                function u(t, e) {
                    var i = "=" + y, n = t.indexOf(i, e), s = r(t.substring(t.indexOf("=", e) + 1, n)).split(" ");
                    return P = s[0], y = s[s.length - 1], n + i.length - 1
                }

                var d = n.length, l = 0, p = 1, f = 2, v = l, g = null, m = null, b = "", w = [], S = !1, k = 0, $ = 0, P = "{{", y = "}}";
                for (s && (s = s.split(" "), P = s[0], y = s[1]), k = 0; k < d; k++)v == l ? i(P, n, k) ? (--k, a(), v = p) : "\n" == n.charAt(k) ? c(S) : b += n.charAt(k) : v == p ? (k += P.length - 1, m = t.tags[n.charAt(k + 1)], g = m ? n.charAt(k + 1) : "_v", "=" == g ? (k = u(n, k), v = l) : (m && k++, v = f), S = k) : i(y, n, k) ? (w.push({
                    tag: g,
                    n: r(b),
                    otag: P,
                    ctag: y,
                    i: "/" == g ? S - P.length : k + y.length
                }), b = "", k += y.length - 1, v = l, "{" == g && ("}}" == y ? k++ : e(w[w.length - 1]))) : b += n.charAt(k);
                return c(S, !0), w
            };
            var k = {_t: !0, "\n": !0, $: !0, "/": !0};
            ...
            t.generate = function (e, r, i) {
                ...
                "#": function (e, r) {
                    r.code += "if(t.s(t." + d(e.n) + '("' + u(e.n) + '",c,p,1),c,p,0,' + e.i + "," + e.end + ',"' + e.otag + " " + e.ctag + '")){t.rs(c,p,function(c,p,t){', t.walk(e.nodes, r), r.code += "});c.pop();}"
                }, "^": function (e, r) {
                    r.code += "if(!t.s(t." + d(e.n) + '("' + u(e.n) + '",c,p,1),c,p,1,0,0,"")){', t.walk(e.nodes, r), r.code += "};"
                }, ">": l, "<": function (e, r) {
                    ...
                    var i = {subs: {}, code: "", partials: r.partials, prefix: e.n};
                    t.walk(e.nodes, i), r.subs[e.n] = i.code, r.inPartial || (r.code += 't.sub("' + u(e.n) + '",c,p,i);')
                }, "\n": function (t, e) {
                    e.code += f('"\\n"' + (t.last ? "" : " + i"))
                }, _v: function (t, e) {
                ...
                r = r || {};
                var i = t.cacheKey(e, r), n = this.cache[i];
                if (n) {
                    var s = n.partials;
        ...
        !function (t) {
            function e(t, e, r) {
                var i;
                return e && "object" == typeof e && (void 0 !== e[t] ? i = e[t] : r && e.get && "function" == typeof e.get && (i = e.get(t))), i
            }
            ...
            function n(t) {
                return t = i(t), d.test(t) ? t.replace(s, "&amp;").replace(a, "&lt;").replace(o, "&gt;").replace(c, "&#39;").replace(u, "&quot;") : t
            }

            t.Template = function (t, e, r, i) {
                t = t || {}, this.r = t.code || this.r, this.c = r, this.options = i || {}, this.text = e || "", this.partials = t.partials || {}, this.subs = t.subs || {}, this.buf = ""
            }, t.Template.prototype = {
                r: function (t, e, r) {
                    return ""
                }, v: n, t: i, render: function (t, e, r) {
                    return this.ri([t], e || {}, r)
                }, ri: function (t, e, r) {
                    return this.r(t, e, r)
                }, ep: function (t, e) {
                    var i = this.partials[t], n = e[i.name];
                    ...
                    var o;
                    return (!l(t) || 0 !== t.length) && ("function" == typeof t && (t = this.ms(t, e, r, i, n, s, a)), o = !!t, !i && o && e && e.push("object" == typeof t ? t : e[e.length - 1]), o)
                }, d: function (t, r, i, n) {
                    var s, a = t.split("."), o = this.f(a[0], r, i, n), c = this.options.modelGet, u = null;
                    if ("." === t && l(r[r.length - 2]))o = r[r.length - 1]; else for (var d = 1; d < a.length; d++)s = e(a[d], o, c), void 0 !== s ? (u = o, o = s) : o = "";
                    ...
                    return this.options.delimiters = s, this.b(this.ct(i(t.call(e, n)), e, r)), this.options.delimiters = a, !1
                }, ct: function (t, e, r) {
                    ...
                    return "function" == typeof u ? !!i || (o = this.activeSub && this.subsText && this.subsText[this.activeSub] ? this.subsText[this.activeSub] : this.text, this.ls(u, c, r, o.substring(n, s), a)) : u
                }, mv: function (t, e, r) {
                    var n = e[e.length - 1], s = t.call(n);
            ...
            var s = /&/g, a = /</g, o = />/g, c = /\'/g, u = /\"/g, d = /[&<>\"\']/, l = Array.isArray || function (t) {
        ...
        var i = r(1), n = {
            addToCart: function (t, e, r) {
                i.request({url: i.getServerUrl("/cart/add.do"), data: t, success: e, error: r})
            }, getCartCount: function (t, e) {
                i.request({url: i.getServerUrl("/cart/get_cart_product_count.do"), success: t, error: e})
            }, getCartList: function (t, e) {
                i.request({url: i.getServerUrl("/cart/list.do"), success: t, error: e})
            }, selectProduct: function (t, e, r) {
                i.request({url: i.getServerUrl("/cart/select.do"), data: {productId: t}, success: e, error: r})
            }, selectAllProduct: function (t, e) {
                i.request({url: i.getServerUrl("/cart/select_all.do"), success: t, error: e})
            }, unselectProduct: function (t, e, r) {
                i.request({url: i.getServerUrl("/cart/un_select.do"), data: {productId: t}, success: e, error: r})
            }, unselectAllProduct: function (t, e) {
                i.request({url: i.getServerUrl("/cart/un_select_all.do"), success: t, error: e})
            }, updateProductCount: function (t, e, r) {
                i.request({url: i.getServerUrl("/cart/update.do"), data: t, success: e, error: r})
            }, deleteProduct: function (t, e, r) {
                i.request({url: i.getServerUrl("/cart/delete_product.do"), data: {productIds: t}, success: e, error: r})
            }
        };
        t.exports = n
    }, 7: function (t, e, r) {
        ...
        var i = r(1), n = {
            getOrderProduct: function (t, e) {
                i.request({url: i.getServerUrl("/order/get_order_cart_product.do"), success: t, error: e})
            }, create: function (t, e, r) {
                i.request({url: i.getServerUrl("/order/create.do"), data: t, success: e, error: r})
            }, cancel: function (t, e, r) {
                i.request({url: i.getServerUrl("/order/cancel.do"), data: {orderNo: t}, success: e, error: r})
            }, getOrderList: function (t, e, r) {
                i.request({url: i.getServerUrl("/order/list.do"), data: t, success: e, error: r})
            }, getOrderDetail: function (t, e, r) {
                i.request({url: i.getServerUrl("/order/detail.do"), data: {orderNo: t}, success: e, error: r})
            }
        };
        t.exports = n
    }, 16: function (t, e, r) {
        ...
        var i = r(1), n = r(66), s = r(16), a = r(37), o = {
            show: function (t) {
                ...
                this.$modalWrap.find(".modal-container").click(function (t) {
                    ...
                    var e = t.getReceverInfo(), r = t.option.isUpdate;
                    e.status && !r ? s.save(e.data, function (e) {
                        i.successTips("地址添加成功"), t.hide(), "function" == typeof t.option.onSuccess && t.option.onSuccess(e)
                    }, function (t) {
                        i.errorTips(t)
                    }) : e.status && r ? s.update(e.data, function (e) {
                        i.successTips("地址修改成功"), t.hide(), "function" == typeof t.option.onSuccess && t.option.onSuccess(e)
                    }, function (t) {
                        i.errorTips(t)
                ...
                var t = {}, e = {status: !1};
                return t.receiverName = $.trim(this.$modalWrap.find("#receiver-name").val()), t.receiverProvince = $.trim(this.$modalWrap.find("#receiver-province").val()), t.receiverCity = $.trim(this.$modalWrap.find("#receiver-city").val()), t.receiverPhone = $.trim(this.$modalWrap.find("#receiver-phone").val()), t.receiverAddress = $.trim(this.$modalWrap.find("#receiver-address").val()), t.receiverZip = $.trim(this.$modalWrap.find("#receiver-zip").val()), this.option.isUpdate && (t.id = this.$modalWrap.find("#receiver-id").val()), t.receiverName ? t.receiverProvince ? t.receiverProvince ? t.receiverAddress ? t.receiverPhone ? (e.status = !0, e.data = t) : e.errMsg = "请输入收件人手机号" : e.errMsg = "请输入收件人详细地址" : e.errMsg = "请选择收件人所在城市" : e.errMsg = "请选择收件人所在省份" : e.errMsg = "请输入收件人姓名", e
            }, hide: function () {
        ...
        "use strict";
        r(22), r(8), r(7);
        var i = r(1), n = r(16), s = r(12), a = r(36), o = r(38), c = r(51), u = {
            data: {}, init: function () {
                this.onLoad(), this.bindEvent()
            }, onLoad: function () {
                ...
                $(document).on("click", ".address-item", function () {
                    ...
                    e.hasClass("add") ? c.show({
                        isUpdate: !1, onSuccess: function () {
                            t.loadAddressList()
                        }
                    }) : (e.addClass("active").siblings(".address-item").removeClass("active"), t.data.selectedAddressId = e.data("id"))
                }), $(document).on("click", ".address-update", function (e) {
                    var r = $(this), s = r.parents(".address-item").data("id");
                    e.stopPropagation(), n.getAddress(s, function (e) {
                        c.show({
                            data: e, isUpdate: !0, onSuccess: function () {
                                t.loadAddressList()
                            }
                        })
                    }, function (t) {
                ...
                if (this.data.selectedAddressId) {
                    for (var e = !1, r = 0, i = t.list.length; r < i; r++)console.log(t.list[r].id), t.list[r].id == this.data.selectedAddressId && (t.list[r].isActive = !0, e = !0);
